...
function RefModification(field) {
    ...
    if (document.selection) {
        ...
        field.value = field.value.substring(0, startPos) + line + field.value.substring(endPos, field.value.length);
        field.focus();
...
function OAndOuKarModification(field, CH1, CH2) {
    if (document.selection) {
        ...
        field.value = field.value.substring(0, startPos) + CH + field.value.substring(endPos, field.value.length);
        field.focus();
...
function GetAvroPhoneticModifiedCharaceter(CUni) {
    ...
    if (CUni != 'হ' && Avro_Cha_Flag == true)
        Avro_Cha_Flag = false;
    if (LCUNI == 'ক' && CUni == 'হ') CMod = 'খ'; else if (LCUNI == 'গ' && CUni == 'হ') CMod = 'ঘ'; else if (LCUNI == 'চ' && CUni == 'হ' && Avro_Cha_Flag == false) {
        CMod = 'চ';
        Avro_Cha_Flag = true;
        ...
        CMod = CUni; else if (IsBanglaBanjonborno(LCUNI) && CUni == 'অ' && Avro_A_Press_Flag == false) {
        ...
        CMod = '\u09CD' + CUni; else if (LCUNI == 'অ' && CUni == 'অ') CMod = 'উ'; else if (LCUNI == 'অ' && CUni == 'ই') CMod = 'ঐ'; else if (LCUNI == 'অ' && CUni == 'ই') CMod = 'ঐ'; else if (LCUNI == 'া' && CUni == 'অ') CMod = 'ও'; else if (LCUNI == 'এ' && CUni == 'এ') CMod = 'ঈ'; else if (LCUNI == 'ে' && CUni == 'অ') CMod = 'ও'; else if (LCUNI == 'ও' && CUni == 'ঈ') CMod = 'ঔ';
...
function ProcessCharacter(field, C, K, CUni) {
    ...
    if (LCUNI == 'অ' && CUni == 'া') {
        ...
        OAndOuKarModification(field, 'ৌ', 'ৗ'); else if (K > 29) {
        Insert(field, CUni);
    } else if (K == 13 && IE) {
        Insert(field, CUni);
    }
